<?php
    ...
    $data = json_decode(file_get_contents("$instance/api/v1/search?q=" .urlencode($_GET['search_query'])), true);
?>

<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<title><?php echo($_GET['search_query']); ?> - YouTube - Broadcast Yourself.</title>
		...
		<div id="baseDiv">
				...
				<form action="results.php" method="get" name="searchForm">
					<div class="bar">
						...
						<div class="search-bar">
							<div id="search-form">
								<input id="search-term" name="search_query" type="text" maxlength="128" value="<?php echo($_GET['search_query']); ?>">
			...
			<div id="homepage-main-content"> 
				<div id="homepage-featured-heading">
					<h1 id="hpVideoListHead">Search: <?php echo($_GET['search_query']); ?></h1>
				</div>

				<div id="homepage-video-list" class="browseListView">
					<div id="hpFeatured">
						<?php for($i = 0; $i <= count($data) - 1; $i++): ?>
                            <?php if($data[$i]['type'] == 'video'): ?>
                                <div class="vlentry">
