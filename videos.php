<?php
    ...
    $data = json_decode(file_get_contents("$instance/api/v1/trending?region=RU"), true);
?>
	...
	<body>
		<div id="baseDiv">
			<div id="masthead">
				...
				<div class="nav">
					<div class="nav-item" id="nav-item-home">
						<span class="leftcap"></span>
						<a class="content" href="index.php">Home</a>
						<span class="rightcap"></span>
					</div>
					<div class="nav-item first selected" id="nav-item-videos">
						<div class="nav-tab">
							<span class="leftcap"></span>
			...
			<div id="homepage-main-content"> 
				<div id="homepage-featured-heading">
					<h1 id="hpVideoListHead">Trending Videos</h1>
				</div>
